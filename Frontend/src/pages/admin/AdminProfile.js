  ...
  return (
    <Container maxWidth="sm" sx={{ py: 4, background: '#ffeaea', borderRadius: 4, boxShadow: 3, mt: 6 }}>
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 3 }}>
        ...
        <Chip label="Quản trị viên" color="secondary" sx={{ mb: 2, fontWeight: 'bold', fontSize: 16, px: 2, py: 1 }} />
        <Typography variant="subtitle1" color="text.secondary" sx={{ mb: 2, textAlign: 'center' }}>
          Quản lý hệ thống hiến máu, hỗ trợ vận hành và kiểm soát dữ liệu toàn hệ thống.
        </Typography>
